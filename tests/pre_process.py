...
class TestCleanText(unittest.TestCase):
    ...
    def test_complex(self):
        ...
        expected_result = "This is a more complex test It includes some numbers like 1234567890 and some punctuation marks such as commas periods colons semicolons exclamation points question marks and parentheses It also includes some nonASCII characters like e a and c Finally it includes some substrings that match regex patterns such as '' '' and ''.'."
